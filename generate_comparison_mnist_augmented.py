...
def generate_comparison_mnist(r, initial_noise, batch_size, num_particles, num_epochs, timesteps):
    ...
    loss_function=None
    adapt_r = None
    As = estimate_weights_enkf_augmented(model, wvec, x_train, y_train, x_test, y_test, dx=0.1, meas_model=meas_model, timesteps=timesteps, num_epochs=num_epochs, ensemble_size=num_particles, batch_size=batch_size, r=r, logger=logger, adapt_r=adapt_r, loss_function=loss_function, initial_noise=initial_noise, Ts=Ts, parallelize=False)
