...
def estimate_weights_enkf(w0, xs, ys, x_test, y_test, dx, meas_model, timesteps, num_epochs, ensemble_size, batch_size, r, logger, adapt_r="None", loss_function="mse", initial_noise=0.03, Ts=None, save_interval=100, parallelize=False):
